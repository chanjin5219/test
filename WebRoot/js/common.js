...
for(var key in provinceArr) {
		...
		provinceOption.value =provinceArr[key][0];
		provinceOption.text = provinceArr[key][1];
...
function showChild(current, child, childArr) {
		var currentValue = current.value;//选中值
